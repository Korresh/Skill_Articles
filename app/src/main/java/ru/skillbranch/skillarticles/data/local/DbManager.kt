...
object DbManager {
    val db = Room.databaseBuilder(
        ...
        //.run{if (BuildConfig.DEBUG)fallbackToDestructiveMigration() else this} //no need migration debug /drop db and create
}
@Database(
    entities = [
        Article::class,
...
abstract class AppDb : RoomDatabase(){
    ...
    abstract fun articleCountsDao(): ArticlesCountsDao
